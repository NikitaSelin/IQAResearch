...
def create_data_lists(train_folders: list[str], test_folders: list[str], min_size: int, output_folder: str) -> None:
    """
    ...
    train_folders : list[str]
        folders containing the training images; these will be merged
    test_folders : list[str]
        folders containing the test images; each test folder will form its own test set
    min_size : int
        minimum width and height of images to be considered
    output_folder : str
        save data lists here
...
def view_random_image(path_to_json: str) -> None:
    """
    ...
    ----------
    path_to_json : str
        The path to the JSON file containing info about the dataset
    
    Returns
    -------
    None
    """
    with open(path_to_json, 'rt') as f:
